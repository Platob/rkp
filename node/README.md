...
Use the complete [JavaScript guide](https://platob.github.io/rkp/extensions/javascript/)
for schema and identifier APIs, the [Record and Arrow guide](https://platob.github.io/rkp/extensions/javascript/records/)
for typed rows and copied IPC interoperability, and the [codec guide](https://platob.github.io/rkp/extensions/javascript/codecs/)
