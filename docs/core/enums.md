...
shipped unexecuted:
[Rust](../notebooks/core_enums-rust.ipynb){ download },
[Python](../notebooks/core_enums-python.ipynb){ download },
[JavaScript](../notebooks/core_enums-javascript.ipynb){ download }.
