...
shipped unexecuted:
[Rust](../notebooks/core_parquet-rust.ipynb){ download },
[Python](../notebooks/core_parquet-python.ipynb){ download },
[JavaScript](../notebooks/core_parquet-javascript.ipynb){ download }.
