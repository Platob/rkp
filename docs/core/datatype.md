...
shipped unexecuted:
[Rust](../notebooks/core_datatype-rust.ipynb){ download },
[Python](../notebooks/core_datatype-python.ipynb){ download },
[JavaScript](../notebooks/core_datatype-javascript.ipynb){ download }.
