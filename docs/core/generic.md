...
shipped unexecuted:
[Rust](../notebooks/core_generic-rust.ipynb){ download },
[Python](../notebooks/core_generic-python.ipynb){ download },
[JavaScript](../notebooks/core_generic-javascript.ipynb){ download }.
